...
public class AirCurrent {
	...
	public void findEntities() {
		...
		final Integer limit = AllConfigs.SERVER.kinetics.fanEntityCheckLimit.get();
		if (limit != -1 && caughtEntities.size() > limit)
			caughtEntities = caughtEntities.subList(0, limit);
	}
